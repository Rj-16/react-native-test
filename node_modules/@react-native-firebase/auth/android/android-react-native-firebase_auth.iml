...
<module external.linked.project.id=":react-native-firebase_auth" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_8">
    ...
    <orderEntry type="library" name="Gradle: com.google.firebase:firebase-auth:19.3.1@aar" level="project" />
    ...
    <orderEntry type="module" module-name="android-react-native-firebase_app" />
  </component>
</module>